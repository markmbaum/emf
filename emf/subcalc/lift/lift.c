...
void lift (double *x, double *y, double *z,
    ...
    generated by a current carrying wire segment in 3d space, at a set of points
    in that 3d space. The wire runs from the point a to point b, or from
    (xa, ya, za) to (xb, yb, zb).
